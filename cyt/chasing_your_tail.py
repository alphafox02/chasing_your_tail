...
cyt_sub = pathlib.Path('/home/ubuntu/chasing_your_tail/cyt/cyt_sub')
...
log_file_name = '/home/ubuntu/chasing_your_tail/cyt/cyt_sub/cyt_log_' + time.strftime('%m%d%y_%H%M%S')
